...
|---|---|---|---|---|
| **low** | confirmed only | touched lines + direct callers | correctness: logic, edge/boundary, error/failure paths · craft: none | inline, single pass |
...
| **high** | + speculative, flagged as unverified | + transitive callers of any changed signature | correctness: all seven · craft: all four (adds efficiency, altitude/consistency) | recruit the adversary + simplicity-hawk critics to attack candidates |
