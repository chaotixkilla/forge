...
1. Preflight gate: require --plugin; run audit-packaging + audit-contract + audit-tool-leaks; refuse to release a plugin that fails, or one marked unpublished  — see [phases/01-preflight-gate.md](phases/01-preflight-gate.md)
