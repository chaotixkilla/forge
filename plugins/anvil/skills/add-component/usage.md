...
- It will not clobber: if a file by that name already exists in the resolved home, it stops and surfaces the choice (extend, rename, abort) rather than overwriting authored work.
